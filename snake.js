...
const btnXSound = document.getElementById('x-sound')
...
btnSound.classList.add('active-btn')
...
function toggleButtonSound() {
  if (btnSound.classList.contains('active-btn')) {
    btnSound.classList.remove('active-btn')
    btnXSound.classList.add('active-btn')
    //* Remove sound
    game.bip.mute()
    game.sound_game_over.mute()
  } else {
    btnSound.classList.add('active-btn')
    btnXSound.classList.remove('active-btn')
    //* Add sound
    game.bip.unMute()
    game.sound_game_over.unMute()
  }
}
...
btnSound.addEventListener('click', toggleButtonSound)
btnXSound.addEventListener('click', toggleButtonSound)
